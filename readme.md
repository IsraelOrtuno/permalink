...
Static permalinks which are not linked to models will receive their names by extracting the controller name and the action from theri fully qualified actions: `UserController@index` will be transformed into `user.index`.
